...
import org.example.encrypt.encryptor.CbcAesEncryptor;
...
public class CbcAesEncryptBenchMark {
    ...
    @Setup(Level.Trial)
    public void setup() {
        simpleAesEncryptor = new CbcAesEncryptor("1234567890", SimpleAesCipherFactory::new);
        objectPoolAesEncryptor = new CbcAesEncryptor("1234567890", ObjectPoolAesCipherFactory::new);
