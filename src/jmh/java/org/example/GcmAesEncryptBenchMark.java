...
import org.example.encrypt.encryptor.GcmAesEncryptor;
...
public class GcmAesEncryptBenchMark {
    ...
    @Setup(Level.Trial)
    public void setup() {
        simpleAesEncryptor = new GcmAesEncryptor("1234567890", SimpleAesCipherFactory::new);
        objectPoolAesEncryptor = new GcmAesEncryptor("1234567890", ObjectPoolAesCipherFactory::new);
